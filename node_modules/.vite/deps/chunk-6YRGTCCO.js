...
} from "./chunk-IVWG5DKR.js";
import {
  IconBase,
  Ripple,
  SpinnerIcon
} from "./chunk-ALAYJNGL.js";
import {
  ComponentBase,
  Portal,
  Tooltip,
...
var VirtualScroller = React6.memo(React6.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React6.useState(both ? {
    rows: 0,
    cols: 0
  } : 0), _React$useState2 = _slicedToArray(_React$useState, 2), firstState = _React$useState2[0], setFirstState = _React$useState2[1];
  var _React$useState3 = React6.useState(both ? {
    rows: 0,
    cols: 0
  } : 0), _React$useState4 = _slicedToArray(_React$useState3, 2), lastState = _React$useState4[0], setLastState = _React$useState4[1];
  var _React$useState5 = React6.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  var _React$useState7 = React6.useState(both ? {
    rows: 0,
    cols: 0
  ...
  var _React$useState9 = React6.useState(props.numToleratedItems), _React$useState10 = _slicedToArray(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = React6.useState(props.loading || false), _React$useState12 = _slicedToArray(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = React6.useState([]), _React$useState14 = _slicedToArray(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
  ...
  var _contentRef = React6.useRef(null);
  var _spacerRef = React6.useRef(null);
  var _stickyRef = React6.useRef(null);
  var lastScrollPos = React6.useRef(both ? {
    top: 0,
    left: 0
  } : 0);
  var scrollTimeout = React6.useRef(null);
  var resizeTimeout = React6.useRef(null);
  var contentStyle = React6.useRef({});
  var spacerStyle = React6.useRef({});
  var defaultWidth = React6.useRef(null);
  var defaultHeight = React6.useRef(null);
  var defaultContentWidth = React6.useRef(null);
  var defaultContentHeight = React6.useRef(null);
  var isItemRangeChanged = React6.useRef(false);
  var lazyLoadState = React6.useRef(null);
  var viewInitialized = React6.useRef(false);
  ...
  var createLoader = function createLoader2() {
    ...
    var icon = props.loadingIcon || React6.createElement(SpinnerIcon, _extends5({}, loadingIconProps, {
      spin: true
    }));
    ...
    if (!props.loaderDisabled && props.showLoader && loadingState) {
      ...
      return React6.createElement("div", loaderProps, _content);
    }
    return null;
  };
  var createSpacer = function createSpacer2() {
    if (props.showSpacer) {
      ...
      return React6.createElement("div", spacerProps);
    }
    return null;
  };
  ...
  var createContent = function createContent2() {
    ...
    var content2 = React6.createElement("div", contentProps, items);
  ...
  if (props.disabled) {
    ...
    return React6.createElement(React6.Fragment, null, props.children, _content2);
  }
  ...
  return React6.createElement("div", rootProps, content, spacer, loader);
}));
...
var DropdownItem = React8.memo(function(props) {
  ...
  return React8.createElement("li", _extends7({
    key: props.label
...
var DropdownPanel = React8.memo(React8.forwardRef(function(props, ref) {
  ...
  var createContent = function createContent2() {
    if (props.virtualScrollerOptions) {
      ...
      return React8.createElement(VirtualScroller, _extends7({
  ...
  var createElement9 = function createElement10() {
    ...
    return React8.createElement(CSSTransition, _extends7({
      nodeRef: ref
    }, transitionProps), React8.createElement("div", _extends7({
      ref
...
var Dropdown = React8.memo(React8.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React8.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var _React$useState3 = React8.useState(-1), _React$useState4 = _slicedToArray2(_React$useState3, 2), focusedOptionIndex = _React$useState4[0], setFocusedOptionIndex = _React$useState4[1];
  var _React$useState5 = React8.useState(false), _React$useState6 = _slicedToArray2(_React$useState5, 2), overlayVisibleState = _React$useState6[0], setOverlayVisibleState = _React$useState6[1];
  ...
  return React8.createElement(React8.Fragment, null, React8.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, React8.createElement(DropdownPanel, _extends7({
    hostName: "Dropdown",
    ref: overlayRef,
    visibleOptions,
    virtualScrollerRef
    ...
    sx
  }))), hasTooltip && React8.createElement(Tooltip, _extends7({
    target: elementRef,
...
//# sourceMappingURL=chunk-6YRGTCCO.js.map
